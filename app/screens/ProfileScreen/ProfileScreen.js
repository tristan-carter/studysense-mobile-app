...
function ProfileScreen({ navigation }) {
  return (
      <Stack.Navigator>
          ...
          options={({route}) => ({ headerBackImage:()=>(<SVGBackButton/>), headerBackTitleVisible:false, headerTitleStyle: { color: colours.titletext, fontSize: 26, fontWeight: 'bold', fontFamily: 'Lato-Bold' }, headerStyle: { height: 83, backgroundColor: colours.titlebackground }})}
          />
