...
function ProfileScreen({ navigation }) {
  return (
      <Stack.Navigator>
          ...
          options={({route}) => ({ headerBackImage:()=>(<SVGBackButton/>), headerBackTitleVisible:false, headerTitleStyle: { color: colours.titletext, fontSize: 28, fontWeight: 'Bold', fontWeight: '600', fontFamily: 'Lato-Bold', fontWeight: '600' }, headerStyle: { height: 90, backgroundColor: colours.backgroundColour }})}
          />
